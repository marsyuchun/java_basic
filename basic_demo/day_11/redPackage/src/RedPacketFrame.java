package basic_demo.day_11.redPackage.src;
...
/**
 * Created by yanyuchun on 2020/3/20
 */
public abstract class RedPacketFrame extends JFrame {


    private static final String DIR = "basic_demo\\day_11\\RedPackage\\pic";
    private static final long serialVersionUID = -4275559106968243278L;
    ...
    private static JTextField open_ownerName = new JTextField("武佳文");
...
//        System.out.println("页面初始化...");
    ...
    /**
     *
     * @Author: yuchun.yan on 2020/3/21 00:14
     * @param: []
     * @return: void
     * @Description:
     */
